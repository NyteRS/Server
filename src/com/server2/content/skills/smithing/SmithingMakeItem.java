...
public class SmithingMakeItem {

	public SmithingMakeItem(Player c, int id, int amount) {
	...
	private void CheckBronze(Player c, int level, int amounttomake, String type) {
		...
		doaction(c, c.smithitem, c.smithremove, c.smithremoveamount,
				c.smithmaketimes, -1, -1, amounttomake);
	...
	private void CheckSteelCannonBalls(Player c, int level, int amounttomake,
			String type) {
		c.smithremove = 2353;
	...
	public boolean doaction(final Player c, final int toadd, final int barID,
		...
		AnimationProcessor.addNewRequest(c, 898, 1);
			...
			public void execute(CycleEventContainer container) {
				...
				if (client != null) {
					...
					if (!client.getActionAssistant().playerHasItem(
							client.barID, client.barsRemoved)) {
					...
					if (client.barID == 2349)
						basexp = 12.5;
					else if (client.barID == 2351)
						basexp = 25;
					else if (client.barID == 2353)
						basexp = 37.5;
					else if (client.barID == 2359)
						basexp = 50;
					else if (client.barID == 2361)
						basexp = 62.5;
					else if (client.barID == 2363)
						basexp = 75;
					if (client.amountToMakeBars > 1
							&& client.getActionAssistant().playerHasItem(
									client.barID, client.barsRemoved * 2))
					...
					if (InstanceDistributor.getItemManager()
							...
							.contains("dart"))
						client.getActionSender().addItem(client.itemToAdd, 10);
					else if (InstanceDistributor.getItemManager()
							.getItemDefinition(client.itemToAdd).getName()
							.contains("nail"))
						client.getActionSender().addItem(client.itemToAdd, 15);
					else if (InstanceDistributor.getItemManager()
							.getItemDefinition(client.itemToAdd).getName()
							.contains("arrow"))
						client.getActionSender().addItem(client.itemToAdd, 15);
							...
							.getItemDefinition(client.itemToAdd).getName()
							.contains("knife"))
						client.getActionSender().addItem(client.itemToAdd, 5);
					else if (InstanceDistributor.getItemManager()
							.getItemDefinition(client.itemToAdd).getName()
							.contains("Cannonball"))
						client.getActionSender().addItem(client.itemToAdd, 4);
					else
						client.getActionSender().addItem(client.itemToAdd, 1);
					if (client.itemToAdd == 1333)
						Achievements.getInstance().complete(client, 58);
					final double xp = basexp * client.barsRemoved;
