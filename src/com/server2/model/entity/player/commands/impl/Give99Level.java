...
public class Give99Level implements Command {
	...
	public void execute(Player client, String command) {
		try {
			...
			if (target != null && SpecialRights.isSpecial(client.getUsername())) {
				target.playerLevel[Integer.parseInt(arguments[2])] = 1;
				target.playerXP[Integer.parseInt(arguments[2])] = 0;
				target.getActionSender().sendMessage(
						"" + client.getUsername()
								+ " has decreased your stats.");
			} else
